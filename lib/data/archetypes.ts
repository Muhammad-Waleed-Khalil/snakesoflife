...
export const snakeArchetypes: SnakeArchetype[] = [
  {
    id: 'ex-gf-viper',
    ...
    crimes: [
      'Breadcrumbing you for months',
      'Posting thirst traps while ignoring your texts',
      'Claiming she "still cares" but dating your friend',
      'Trauma-dumping then disappearing',
    ],
    fakeQuote: 'I swear I\'ve changed—just don\'t look at my DMs with other guys.',
    lifeLesson:
      'Block. Delete. Move on. Nostalgia is a trap, and she knows it. Your peace is worth more than her validation.',
  },
  {
    id: 'ghosting-boa',
    ...
    crimes: [
      ...
      'Blocking you on everything with no warning',
      'Reappearing months later like nothing happened',
      'Gaslighting you about "overreacting"',
    ],
    fakeQuote: 'I just needed space... for six months... without telling you.',
    lifeLesson:
      'Closure is a gift you give yourself. Anyone who ghosts you has shown you exactly who they are—believe them.',
  },
  {
    ...
    crimes: [
      'Spreading your secrets to mutual friends',
      'Flirting with your crush/ex behind your back',
      'Playing victim when you confront her',
      'Smiling in your face while plotting',
    ],
    fakeQuote: 'OMG I would NEVER tell anyone... except like, everyone.',
    lifeLesson:
      'Real friends protect your secrets like their own. If she gossips TO you, she gossips ABOUT you.',
  },
  {
    ...
    fakeQuote: 'That never happened. You\'re just being paranoid again.',
    lifeLesson:
      'Trust your gut. Write things down. Your memory isn\'t broken—their manipulation is just that good.',
  },
  {
    ...
    crimes: [
      'Presenting your work as theirs in meetings',
      'Undermining you while stealing your strategies',
      'Taking credit for team wins, blaming you for losses',
      'Schmoozing with bosses using your insights',
    ],
    fakeQuote: 'Great minds think alike! I had the same idea... right after you told me.',
    lifeLesson:
      'Document everything. Email your ideas. CC the boss. Cover your ass—because they won\'t.',
  },
  {
    ...
    crimes: [
      ...
      'Comparing your life to theirs constantly',
      'Spreading family drama about you',
      'Being sweet to your face, cruel behind your back',
    ],
    fakeQuote: 'No offense, but maybe if you tried harder... just saying, love you though!',
    lifeLesson:
      'Blood doesn\'t mean loyalty. Distance yourself from toxic family—your mental health comes first.',
  },
  {
    ...
    crimes: [
      ...
      'Trauma-dumping without asking if you have capacity',
      'Ignoring your problems completely',
      'Making your achievements about them',
    ],
    fakeQuote: 'Enough about me... wait, what were you saying? Actually, let me tell you MORE about me.',
    lifeLesson:
      'Friendship is reciprocal. If you\'re always giving and never receiving, you\'re being used, not loved.',
  },
  {
    ...
    crimes: [
      'Backhanded compliments ("Wow, you\'re brave to try that!")',
      'Sharing your failures with others',
      'Competing with you while pretending to support',
      'Downplaying your achievements',
    ],
    fakeQuote: 'I\'m SO proud of you! I mean, I didn\'t think you could do it, but still!',
    lifeLesson:
      'Real support feels warm, not cold. If their encouragement comes with doubt, it\'s not support—it\'s sabotage.',
  },
];
